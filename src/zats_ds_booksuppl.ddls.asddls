...
define view entity ZATS_DS_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZATS_DS_BOOKING as _Booking on $projection.BookingId = _Booking.BookingId and
$projection.TravelId = _Booking.TravelId
association[1..1] to ZATS_DS_TRAVEL as _Travel on
