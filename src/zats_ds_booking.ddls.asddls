...
define view entity ZATS_DS_BOOKING as select from /dmo/booking_m
composition[0..*] of ZATS_DS_BOOKSUPPL as _BookingSupplement
association to parent ZATS_DS_TRAVEL as _Travel_id on $projection.TravelId = _Travel_id.TravelId
